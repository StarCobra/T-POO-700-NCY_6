defmodule Api.Tables do
  ...
  def get_workingtime_by_user_id_and_id(userid, id) do
  ...
  def get_workingtimes_by_userid!(userid) do
    from(w in Workingtime,
  ...
  def get_workingtime_by_user_id_and_start_and_end(userid, start, endd) do
    from(w in Workingtime,
